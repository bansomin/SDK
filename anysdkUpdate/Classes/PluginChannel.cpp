...
void PluginChannel::loadPlugins()
{
    ...
    std::string appKey = "29B94BAF-75C2-D3AE-5312-855745BF875F";
    std::string appSecret = "775c733fd4b5081730261764f81c1279";
    std::string privateKey = "60EC380452AF707B706704BDD1E4551C";
